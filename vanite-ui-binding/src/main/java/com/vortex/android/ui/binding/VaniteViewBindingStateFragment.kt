 ...
 */
abstract class VaniteViewBindingStateFragment<ViewBindingType : ViewBinding, State : VaniteState, Action : VaniteAction, Reducer : VaniteViewModel<State, Action>>(private val inflate: Inflate<ViewBindingType>) : VaniteBaseFragment(), VaniteRxStore.VortexStateListener<State>,
