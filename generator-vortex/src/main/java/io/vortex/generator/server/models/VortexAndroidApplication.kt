package io.vortex.generator.server.models

import io.vortex.generator.server.VortexAppKeys
import io.vortex.generator.server.models.keys.VortexAndroidAppReadmeType

/**
 * VortexAndroidApplication is the Android App Details
 * The Model Request To Generate Apps Depends on App Details
 */
data class VortexAndroidApplication(
